...
public class WorldGenerator : MonoBehaviour
{
    ...
    public float towerChance = 0.01f;
    ...
    void Start()
    {
        ...
        foreach (Vector3Int point in GridManager.GetAllGridPointsInRange(Vector3Int.zero, 15))
        {
            ...
            if (Random.Range(0f, 1f) < towerChance)
            {
                GameObject tower = Instantiate(GameManager.Main.tower, GridManager.GetWorldPosition(point), Quaternion.identity);
            }
